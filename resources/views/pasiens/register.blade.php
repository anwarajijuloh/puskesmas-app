        ...
        <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
            <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
                <div class="sm:mx-auto sm:w-full sm:max-w-sm">
                    ...
                    <h2 class="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Buat akun
                        puskesmasmu
                    </h2>
                </div>

                <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                    <form class="space-y-6" action="{{ route('pasien.processRegister') }}" method="POST">
                        @csrf
                        <div>
                    ...
                    <p class="mt-10 text-center text-sm text-gray-500">
                        ...
                        <a href="{{ route('pasien.login') }}"
                            class="font-semibold leading-6 text-green-600 hover:text-green-500">Login sekarang</a>
                    </p>
                </div>
            </div>
        </div>
