    ...
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-2xl mx-auto bg-white p-6 rounded-lg shadow-md">
            <div class="flex items-center justify-center mb-6">
                @if ($pasien->photo)
                    <img src="{{ asset($pasien->photo) }}" alt="Profile Photo"
            ...
            <div class="mb-4">
                <label class="block text-gray-700 text-sm font-bold mb-2"
                    for="tgl_lahir">{{ __('Date of Birth') }}</label>
                <input type="date" value="{{ $pasien->tgl_lahir }}"
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                    readonly>
            </div>
            <div class="mb-4">
                <label class="block text-gray-700 text-sm font-bold mb-2" for="umur">Umur</label>
                <input type="text" value="{{ $pasien->age() }} Tahun" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" readonly>
            </div>

            <div class="mb-4">
                <label class="block text-gray-700 text-sm font-bold mb-2" for="alamat">{{ __('Alamat') }}</label>
                <input type="text" value="{{ $pasien->alamat ?? 'Not set' }}"
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                    readonly>
            </div>
